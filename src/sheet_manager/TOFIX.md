...
- DataCatalog rows open details on click/Enter/Space; the separate "View" button is gone
- Bottom sheet drag handle spans the full header width and drags with mouse as well as touch
