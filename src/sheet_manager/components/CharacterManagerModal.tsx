...
export function CharacterManagerModal({ open, onOpenChange }: CharacterManagerModalProps) {
    ...
    const [tailwindRoot] = useState<Element | null>(() =>
        typeof document !== 'undefined' ? document.querySelector('#character-sheet-root') : null
    );
