...
import { AutoResizeTextarea } from '@site/src/sheet_manager/components';
import {
    getSafePortraitUrl,
    loadPortrait,
    savePortrait,
...
const DROID_FIELD_CONFIGS: typeof FIELD_CONFIGS = [
    { key: 'name', ...uiMessages.sheet.base.fields.name },
    { key: 'concept', ...uiMessages.sheet.base.fields.concept },
    {
        key: 'template',
        label: uiMessages.sheet.documents.fields.type,
        placeholder: uiMessages.sheet.documents.fields.type,
    },
    { key: 'player', ...uiMessages.sheet.base.fields.player },
    { key: 'nature', ...uiMessages.sheet.base.fields.nature },
    {
        key: 'owner',
        label: uiMessages.sheet.documents.fields.owner,
        placeholder: uiMessages.sheet.documents.fields.owner,
    },
    { key: 'adventure', ...uiMessages.sheet.base.fields.adventure },
    { key: 'demeanor', ...uiMessages.sheet.base.fields.demeanor },
    { key: 'age', ...uiMessages.sheet.base.fields.age },
...
export function BaseBlock({ accentColor = 'primary' }: BaseBlockProps) {
    ...
    const isMechanical = metadata.type === 'droid';
    const fieldConfigs = isMechanical ? DROID_FIELD_CONFIGS : FIELD_CONFIGS;
                ...
                >
                    <SectionCard>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                            ...
                            {renderField(fieldConfigs[7])}
                            {renderField(fieldConfigs[8])}
                        </div>
                    </SectionCard>
