            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="col-span-2 space-y-4">
                    {renderCollapsibleSection(
                        'inventory',
                        handlers.isMechanical
                            ? translate(uiMessages.sheet.documents.fields.builtInEquipment)
                            : 'Inventory',
                        <InventorySection
                ...
                <HealthBlock
                    conditionKind={handlers.isMechanical ? 'vehicle-damage' : 'health'}
                    docsPath={HEALTH_DOCS}
                />
            </div>
        </CollapsibleBlock>
    );
