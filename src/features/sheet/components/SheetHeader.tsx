...
export function SheetHeader() {
    ...
    const handleReset = () => {
        if (!currentCharacter) return;
        if (!confirm('Are you sure you want to reset all sheet data? This cannot be undone.'))
            return;
        ...
        <div className="bg-slate-800/50 border-b border-slate-700 p-4">
            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <button
                        onClick={handleReset}
                        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-rebel-red bg-slate-700 hover:bg-slate-600 rounded transition-colors"
            ...
            {isExpanded && (
                <div className="space-y-4">
                    ...
                    {/* Line 2: Player, Nature, Home World */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
