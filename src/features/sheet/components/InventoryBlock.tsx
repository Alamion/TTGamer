...
export function InventoryBlock() {
    ...
    const [expandedSections, setExpandedSections] = useLocalStorageState(
        'inventoryBlock_sections',
        { inventory: true, armor: false, weapons: false }
    );
                                    ...
                                    <tr key={item.id}>
                                        <td className="py-1">
                                            <input
                                                ...
                                                value={item.type}
                                                onChange={(e) =>
                                                    updateArmorItem(item.id, 'type', e.target.value)
                                                }
                                        ...
                                        <td className="py-1">
                                            <input
                                                ...
                                                value={item.ar}
                                                onChange={(e) =>
                                                    updateArmorItem(item.id, 'ar', e.target.value)
                                                }
                                                className="w-full bg-slate-900 border border-slate-700 rounded px-2 py-1 text-slate-300"
                                                placeholder="AR..."
                                            />
                                        ...
                                        <td className="py-1">
                                            <input
                                                ...
                                                value={item.dex}
                                                onChange={(e) =>
                                                    updateArmorItem(item.id, 'dex', e.target.value)
                                                }
                                                className="w-full bg-slate-900 border border-slate-700 rounded px-2 py-1 text-slate-300"
                                                placeholder="Dex..."
                                            />
