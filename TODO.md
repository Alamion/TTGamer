...
- [ ] ⬜ **T-081 — Primary and secondary accents in the template editor** (none) — the template editor and the library use the app's primary and secondary colors for selection, frames, pressed modes, and help, like the rest of the app; the violet becomes a `tertiary` token kept for edge cases (for example parts added automatically), per the accent roles in the theming skill. (task for roadmap path `gm-notes-templates`)
